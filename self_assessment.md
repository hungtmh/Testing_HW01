# Bảng Tự Chấm Điểm (Self-Assessment) – HW01
...
Các artifact sau đây **DO TÔI TỰ LÀM**, không dùng AI:

| Artifact | Trạng thái |
|----------|-----------|
| Ảnh thiết bị + thẻ sinh viên cùng khung | ✅ Tự chụp |
| Video thực thi (≥ 5) có voice narration | ✅ Tự quay + thuyết minh bằng giọng tôi |
| 10 screenshot job posting hiển thị login name | ✅ Tự chụp, hiển thị tài khoản cá nhân |
| Prompt log `.md` với timestamp thực | ✅ Tự ghi trong quá trình làm bài |

---

*MSSV: 23127195 — 02/06/2026*
