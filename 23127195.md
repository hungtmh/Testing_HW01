...
| **Các bước thực hiện** | 1. Tăng lên tốc độ 3<br>2. Đo dB bằng app điện thoại đặt cách 1 m<br>3. Chạy tay trong luồng gió để cảm nhận cường độ<br>4. Quan sát rung động thân quạt 60 giây |
| **Kết quả mong đợi** | Gió mạnh nhất, tiếng ≤ 60 dB ở khoảng cách 1 m, không rung động bất thường |
| **Kết quả thực tế** | **Đo được ~64–66 dB** (vượt mức thông thường). Xuất hiện tiếng rít cơ học nhẹ ở tần số cao, có thể nghe rõ trong phòng yên tĩnh. Thân quạt rung nhẹ |
| **Verdict** | ❌ **FAIL** — **[DEFECT-01]** Tiếng ồn bất thường ở tốc độ 3 |

> **DEFECT-01:** Tiếng rít cơ học ở tốc độ 3, mức ồn ~64–66 dB (cao hơn mong đợi). Nguyên nhân nghi ngờ: trục cánh quạt hoặc ổ bi chưa được bôi trơn đầy đủ từ nhà máy. *Severity: Medium*
...
### TC07 – Kiểm Tra Điều Chỉnh Chiều Cao Cột Quạt
...
| **Các bước thực hiện** | 1. Tắt quạt, rút điện<br>2. Mở khóa cột và kéo lên mức cao nhất<br>3. Khóa lại, thử ấn nhẹ từ trên xuống<br>4. Thu cột về mức thấp nhất, khóa và kiểm tra |
| **Kết quả mong đợi** | Cột trượt trơn tru; khi khóa không bị tụt hay rung lắc khi ấn nhẹ (lực < 5 kg) |
| **Kết quả thực tế** | Cột trượt tốt, khóa cứng chắc. Không có hiện tượng tụt khi ấn nhẹ |
| **Verdict** | ✅ **PASS** |
...
> *(Sinh viên chèn link video hoặc đường dẫn file video vào đây)*
